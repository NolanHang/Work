...
// var featureCol = ee.FeatureCollection([yaohang1,yaohang2]).geometry();
// var box = featureCol.buffer(5000);
var distDir = -1;
var startYear = 1990; 
var endYear = 2021; 
var startDay = '-01-01'; 
...
var extractDisturbance = function(lt, distDir, sort, params, mmu){
...
for(var j = 0;j<number_index;j++){
  ...
  Map.addLayer(max_distImg_gain.select(['yod']), viz, index_put+'_'+'expand_year');    // add disturbance year of detection to map
}  
